			...
			<div class="row justify-content-center">
				...
				<div class="col-md-6 col-lg-4 mb-5">
					<div class="portfolio-item mx-auto" data-toggle="modal"
						...
						<img class="img-fluid"
							src="${root }/assets/img/portfolio/cabin.png" alt="" />
					</div>
				</div>
	...
	<section class="page-section bg-primary text-white mb-0" id="about">
		<div class="container">
			...
			<div class="row" id="cos_contents">
				<div class="col">
					<h3><a href="${root}/mvNews" style="text-decoration: none;
					color: white;
					">오늘의 뉴스</a></h3>
					<div class="divider-custom divider-light">
						<div class="divider-custom-line"></div>
						...
						<c:if test="${newslist ne null }">
							<table class="table table-hover ">
								<c:forEach var="news" items="${newslist}">
									<tr>
										<th><a href="${news.originallink}" style="text-decoration: none; color: white; font-size: 20px;">${news.title}</a>
									</tr>
								</c:forEach>
								<tr><th></th></tr>
							</table>
