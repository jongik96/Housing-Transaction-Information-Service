...
<body id="page-top">
	...
	<br>
	<div class="container">
	<button type="button"  class="mt-5 btn btn-primary pull-right" id="" onclick ="location.href='${root}/article/mvwrite'">글쓰기</button>
	</div>
					...
					<c:forEach var="article" items="${articles}">
						<table class="table table-active">
							<tbody>
								...
								<tr>
									<td colspan="2" class=""><strong>${article.articleno}.
								...
								<c:if test="${userinfo.userid == article.userid}">
									<tr>
										<td colspan="2"><a
											 href="${root}/article/mvmodify?articleno=${article.articleno}">수정</a>
											<a
